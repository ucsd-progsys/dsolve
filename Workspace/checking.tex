...
\inferrule[sub-ty]
  {\Gamma \vdash e : \rho' \tau \\ \rho' \sqsubseteq \rho}
  {\Gamma \vdash e : \rho \tau}


\inferrule[sub-func]
  {\Gamma \vdash e : \rho' ({\gamma}_1' \rightarrow {\gamma}_2' ) \\ \rho' \sqsubseteq \rho \\ {\gamma}_1 \sqsubseteq {\gamma}_1' \\ {\gamma}_2' \sqsubseteq {\gamma}_2}
...
\inferrule[app]
  {\Gamma \vdash e_1 : \gamma \rightarrow \gamma' \\ \Gamma \vdash e_2 : \gamma}
