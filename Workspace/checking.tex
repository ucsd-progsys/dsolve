...
\inferrule[if]
  {\Gamma \vdash e_1 : {\tau}_1; C_1 \\ \Gamma \vdash e_2 : {\tau}_2; C_2 \\ \Gamma \vdash e_3 : {\tau}_3; C_3}
...
\inferrule[abs]
  {\Gamma[x \mapsto {\tau}_x] \vdash e : {\tau}_e; C_e}
...
\inferrule[app]
  {\Gamma \vdash e_1 : {\tau}_1; C_1 \\ \Gamma \vdash e_2 : {\tau}_2; C_2}
