...
and qualifier_declaration i ppf q qd =
  line i ppf "qualifier_declaration %a\n" fmt_location qd.pqual_loc;
  let i = i+1 in
  (* pmr: we may want to fill this in later... *)
  line i ppf "pqual_desc = ...\n";
...
and structure_item i ppf x =
  ...
  | Pstr_type (l) ->
      ...
      list i string_x_type_declaration ppf l;
  | Pstr_qual (q, qd) ->
      line i ppf "Pstr_qual\n";
      qualifier_declaration i ppf q qd;
  | Pstr_exception (s, ed) ->
