...
let _frames = [
  ...
  rel_frame ["lt_int"; "Perversives"] "<" Predicate.Lt;
  rel_frame ["le_int"; "Perversives"] "<=" Predicate.Le;
  rel_frame ["gt_int"; "Perversives"] ">" Predicate.Gt;
  rel_frame ["ge_int"; "Perversives"] ">=" Predicate.Ge;
