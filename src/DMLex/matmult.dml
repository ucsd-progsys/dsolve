...
qualif QARRAY_LENGTH__AA_EQ_ARRAY_LENGTH_IN_Q(_AA) : Array.length _AA = Array.length in_q;;
qualif QARRAY_LENGTH__AA_EQ_ARRAY_LENGTH_IN_R(_AA) : Array.length _AA = Array.length in_r;;
...
qualif QARRAY_LENGTH__AA_GE_ARRAY_LENGTH_IN_Q(_AA) : Array.length _AA >= Array.length in_q;;
qualif QARRAY_LENGTH__AA_GE_ARRAY_LENGTH_IN_R(_AA) : Array.length _AA >= Array.length in_r;;
...
qualif QARRAY_LENGTH__AA_LE_ARRAY_LENGTH_IN_Q(_AA) : Array.length _AA <= Array.length in_q;;
qualif QARRAY_LENGTH__AA_LE_ARRAY_LENGTH_IN_R(_AA) : Array.length _AA <= Array.length in_r;;
...
qualif QARRAY_LENGTH__AA_NE_ARRAY_LENGTH_IN_Q(_AA) : Array.length _AA != Array.length in_q;;
qualif QARRAY_LENGTH__AA_NE_ARRAY_LENGTH_IN_R(_AA) : Array.length _AA != Array.length in_r;;
...
qualif Q_AA_EQ_ARRAY_LENGTH_IN_Q(_AA) : _AA = Array.length in_q;;
qualif Q_AA_EQ_ARRAY_LENGTH_IN_R(_AA) : _AA = Array.length in_r;;
...
qualif Q_AA_GE_ARRAY_LENGTH_IN_Q(_AA) : _AA >= Array.length in_q;;
qualif Q_AA_GE_ARRAY_LENGTH_IN_R(_AA) : _AA >= Array.length in_r;;
...
qualif Q_AA_LE_ARRAY_LENGTH_IN_Q(_AA) : _AA <= Array.length in_q;;
qualif Q_AA_LE_ARRAY_LENGTH_IN_R(_AA) : _AA <= Array.length in_r;;
...
qualif Q_AA_NE_ARRAY_LENGTH_IN_Q(_AA) : _AA != Array.length in_q;;
qualif Q_AA_NE_ARRAY_LENGTH_IN_R(_AA) : _AA != Array.length in_r;;
